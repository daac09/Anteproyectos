            ...
            <div class="mask" style="background-color: rgba(0, 0, 0, 0.7);">
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="text-white">
                        ...
                        <h5 class="mb-4">Listado de Estudiantes</h5>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="container">
        ...
        <c:forEach var="fila" items="${result.rows}">
            <tr>
                ...
                <td><c:out value = "${fila.programa}" /></td>
                <td><c:out value = "${fila.semestre}" /></td>
                <td><c:out value = "${fila.fecha_nac}" /></td>
                ...
                <td> <a href="eliminar_est.jsp?id=${fila.id}" class="delete" title="Eliminar"
                        data-toggle="tooltip"> <i class="material-icons">&#xE92B;</i></a>
                     <a href="actualizar_est.jsp?id=${fila.id}" class="edit" title="Editar"
                        data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                </td>
            </tr>
            </c:forEach>
    ...
    <br>
    <button type="button" class="btn btn-dark" onclick="window.location.href='agregar_usu.jsp'">Registrar Estudiante</button>
