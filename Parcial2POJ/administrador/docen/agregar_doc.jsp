...
<body>
    ...
    <h2><center>Agregar Docente</center></h2>
    ...
    <div class="container-xl">
    	<form class="bg-white formulario border border-primary border-4 shadow-lg p-5 mb-5 rounded" method="post">
            ...
            <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="area" value="${fila.prog}" required>
			</div>
            <div class="form-group">
			    <label for="tel" class="form-label">Telefono: </label>
			    <input type="tel" class="form-control" name="tel" value="${fila.sem}" required>
			</div>
            <div class="form-group">
    ...
    <c:if test="${param.nombre != null}">
        <sql:update var="result" dataSource="${parcial}">
            INSERT INTO
            profesores (cedula,nombre,area,tel,cat,id_user)
            values ('${param.cedula}',
            '${param.nombre}',
            '${param.area}',
            ${param.tel},
