            ...
            <div class="mask" style="background-color: rgba(0, 0, 0, 0.7);">
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="text-white">
                        ...
                        <h5 class="mb-4">Docente: <c:out value = "${fila.nombre}" /></h5>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="btn-group btn-group-justified mt-5">
                    <a href="director.jsp?id=${param.id}" class="btn btn-primary btn-lg">Director</a>
                    <a href="evaluador.jsp?id=${param.id}" class="btn btn-primary btn-lg">Evaluador</a>
                </div>
            </div>
            </c:forEach> 
            <div class="container">
