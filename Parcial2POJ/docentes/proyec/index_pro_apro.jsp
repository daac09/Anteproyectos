...
<head>
    ...
    <body>
                ...
                <sql:query var="result" scope="request" dataSource="${parcial}">
                    Select * from proyectos where id_pro_dir = ${fila.id}
                </sql:query>
                <div class="container">
                <div class="mask container" style="background-color: rgba(0, 0, 0, 0.7);">
                    <div class="d-flex justify-content-center align-items-center h-100">
                        <div class="text-white">
                            <h1>Anteproyectos como Director</h1>
                        </div>
                    </div>
                </div>
                <div class="mask container" style="background-color: rgba(0, 0, 0, 0.7);">
                                ...
                                <c:if test="${fila.apro_dir == null}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="aprob_pro_no.jsp?id=${fila.id_pro}" class="edit" title="Editar"
                                            data-toggle="tooltip"><i class="material-icons">close</i></a>                                        
                                        </td>
                                    </tr>
                                </c:if>
                            </c:forEach>
                ...
                <table class="table table-dark">
                    ...
                    <button type="button" class="btn btn-dark"
                        onclick="window.location.href='../director.jsp?id=${param.id}'">Volver</button>
                </div>
            </c:forEach> 
