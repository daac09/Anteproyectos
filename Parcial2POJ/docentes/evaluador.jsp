        ...
        <header class="p-3 bg-dark text-white">
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-end">
                    <div class="text-end">
                        <a href="index_doc.jsp?id=${param.id}"><button type="button" class="btn btn-info">Volver</button></a>
                    </div>
                </div>
            ...
            <div class="mask" style="background-color: rgba(0, 0, 0, 0.7);">
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="text-white">
                        ...
                        <h5 class="mb-4">Docente evaluador: <c:out value = "${fila.nombre}" /></h5>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="btn-group btn-group-justified mt-5">
                    <a href="proyec_eva/index_pro.jsp?id=${param.id}" class="btn btn-primary btn-lg">Ver Anteproyectos</a>
                    <a href="proyec_eva/index_pro_apro.jsp?id=${param.id}" class="btn btn-primary btn-lg">Aprobar Anteproyectos</a>
                </div>
            </div>
            </c:forEach> 
            <div class="container">
