...
<sql:query var="result" scope="request" dataSource="${parcial}">
        Select * from coordinadores WHERE id_user = ${param.id}
        </sql:query>    
            ...
            <div class="mask" style="background-color: rgba(0, 0, 0, 0.7);">
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="text-white">
                        ...
                        <h5 class="mb-4">Coordinador: <c:out value = "${fila.nombre}" /></h5>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="btn-group btn-group-justified mt-5">
                    <a href="proyec/index_pro_asig.jsp?id=${param.id}" class="btn btn-primary btn-lg">Asignar Director y Evaluador</a>
                    <a href="proyec/index_pro.jsp?id=${param.id}" class="btn btn-primary btn-lg">Aprobar proyectos</a>
                    <a href="proyec/index_buscar.jsp?id=${param.id}" class="btn btn-primary btn-lg">Buscar por ID de estudiante</a>
                </div>
            </div>
                    </c:forEach> 
            <div class="container">
